...
- Do not recommend autonomous payments without identity, consent, audit logs, fraud controls, and human escalation.
- Separate public evidence from verified internal implementation evidence.
